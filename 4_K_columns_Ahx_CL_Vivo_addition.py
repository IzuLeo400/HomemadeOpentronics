...
metadata = {
    "protocolName": "4 K columns Ahx, CL, Vivo addition",
...
def run(protocol: protocol_api.ProtocolContext) -> None:
    ...
    reservoir_2 = protocol.load_labware_from_definition(
    ...
    pipette_left.transfer_with_liquid_class(
        volume=300,
        source=[reservoir_2["A2"], reservoir_2["A2"], reservoir_2["A2"], reservoir_2["A2"]],
        dest=[well_plate_1["A1"], well_plate_1["A2"], well_plate_1["A3"], well_plate_1["A4"]],
        new_tip="once",
        trash_location=protocol.fixed_trash,
        keep_last_tip=True,
    ...
    # Step 5: Ahx pause
    protocol.delay(seconds=10800, msg="Ahx pause")
